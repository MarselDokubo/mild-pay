...
import { canRemoveBranding, canShowDiscountBanner } from "~/server/permisions";

// This endpoint collects page visits analytics and returns a script that creates the customized banner for the product
